...
// 题库注册表
const BANK_REGISTRY = [
  ...[2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2020].map(
  ...
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2010 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2011 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2012 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2013 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2014 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2015 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2016 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2017 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2018 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  ...
  },
  {
    ...
    releaseLabel: '正式题库',
    caution:
      '1-46题已按本地百度网盘 2020 英语二答案速查 PDF 与逐题细解 PDF 匹配；47-48 写作题按原卷写作任务训练，不提供唯一范文答案',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('完形填空', '阅读理解', '新题型', '翻译', '写作')
  },
  ...
  ...[2005, 2006, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020].map((year) => ({
    id: `math1-${year}`,
    subject: '数学',
    subjectKey: 'math',
    track: 'math1',
  ...
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2015 数学二真题解析 PDF 页图训练；题面使用逐题裁切图，答案页裁除页眉页脚推广',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2017 数学二真题解析 PDF 页图训练；题面使用逐题裁切图避免提前展示答案解析',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2018 数学二真题及解析 PDF 页图训练；题面使用逐题裁切图避免提前展示答案解析',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  ...
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2020 数学二真题 PDF 页图训练；题面使用逐题裁切图，答案页裁除页眉页脚推广',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  ...
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2015 数学三真题及解析 PDF 页图训练；题面使用逐题裁切图避免提前展示答案解析',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  ...
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2017 数学三真题及解析 PDF 页图训练；题面使用逐题裁切图避免提前展示答案解析',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
  ...
  },
  {
    ...
    description: '8道选择 + 6道填空 + 9道解答题',
    releaseLabel: '正式题库',
    caution: '按本地百度网盘 2019 数学三真题及解析 PDF 页图训练；题面使用逐题裁切图避免提前展示答案解析',
    paperType: 'past_exam',
    quality: PAPER_QUALITY.READY,
    sections: paperSections('选择题', '填空题', '解答题')
  },
