    ...
    <scroll-view scroll-y class="content-scroll">
      <view class="content-section">
        ...
        <view class="section">
          ...
          <text class="section-text">欢迎使用 Exam Master（以下简称"本应用"）。我们深知个人信息对您的重要性，将严格遵守相关法律法规，采取相应的安全保护措施，保护您的个人信息安全。</text>
        </view>
        ...
        <view class="section">
          ...
          <text class="section-text">2. 学习数据：您的刷题记录、错题本、收藏、学习计划等，用于提供个性化学习服务。</text>
          ...
          <text class="section-text">5. 麦克风：仅在您主动使用AI语音对话功能时调用。</text>
        ...
        <view class="section">
          ...
          <text class="section-text">您的数据存储在安全的云服务器上，我们采用加密传输和访问控制等技术手段保护您的信息安全。我们不会将您的个人信息出售、出租或以其他方式提供给第三方。</text>
        </view>

        <view class="section">
          <text class="section-title">五、您的权利</text>
          <text class="section-text">您有权查看、修改您的个人资料信息。您可以在"设置"页面中管理您的账号信息。如需删除账号及相关数据，请联系我们。</text>
        </view>

        <view class="section">
          <text class="section-title">六、未成年人保护</text>
          <text class="section-text">我们重视对未成年人个人信息的保护。如您为未满18周岁的未成年人，请在监护人的陪同和指导下使用本应用。</text>
        </view>

        <view class="section">
          <text class="section-title">七、隐私政策的更新</text>
          <text class="section-text">我们可能会适时修订本隐私政策。更新后的政策将在本页面发布，建议您定期查阅。</text>
        </view>

        <view class="section">
          <text class="section-title">八、联系我们</text>
          <text class="section-text">如您对本隐私政策有任何疑问，请通过应用内"设置"页面的反馈功能与我们联系。</text>
        </view>
      </view>
    </scroll-view>
  </view>
