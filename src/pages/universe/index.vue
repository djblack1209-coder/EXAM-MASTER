	...
	<view class="universe-container" @touchstart="handleScreenTouch" @touchend="handleScreenTouchEnd">
		...
		<view class="loading-overlay" v-if="isLoading">
			...
			<view class="starfield">
				<view class="star-layer layer-1"></view>
				<view class="star-layer layer-2"></view>
				<view class="star-layer layer-3"></view>
			</view>
	...
	methods: {
		...
		renderBgStars(ctx) {
			...
			this.bgStars.forEach(star => {
				...
				if (projected && projected.x > 0 && projected.x < this.canvasWidth &&
					projected.y > 0 && projected.y < this.canvasHeight) {
		...
		renderPlanet(ctx) {
			...
			allParticles.forEach(p => {
				...
				if (projected && projected.x > -50 && projected.x < this.canvasWidth + 50 &&
					projected.y > -50 && projected.y < this.canvasHeight + 50) {
