...
export const trackingMixin = {
  ...
  methods: {
    ...
    _startPageTracking(options = {}) {
      ...
      console.log('[TrackingMixin] 开始追踪页面:', this._tracking.pageRoute);
    },
    ...
    _endPageTracking() {
      ...
      console.log('[TrackingMixin] 结束追踪页面:', this._tracking.pageRoute, '停留时间:', stayTime + 'ms');
    },
