...
export const todoStorePatch = {
  ...
  addTodo(store, todo) {
    ...
    console.log('[TodoStorePatch] 添加待办:', newTodo.title);
    return newTodo;
  },
  ...
  updateTodo(store, todo) {
    ...
    console.log('[TodoStorePatch] 更新待办:', updatedTodo.title);
    return updatedTodo;
  },
  ...
  deleteTodo(store, todoId) {
    ...
    console.log('[TodoStorePatch] 删除待办:', deleted.title);
    return true;
  },
  ...
  toggleTodo(store, todoId) {
    ...
    console.log('[TodoStorePatch] 切换待办状态:', task.title, task.done);
    return true;
  },
  ...
  reorderTodos(store, fromIndex, toIndex) {
    ...
    console.log('[TodoStorePatch] 重新排序:', fromIndex, '->', toIndex);
  },
  ...
  clearCompleted(store) {
    ...
    console.log('[TodoStorePatch] 清除已完成待办:', completedIds.length);
  ...
  scheduleReminder(todo) {
    ...
    console.log('[TodoStorePatch] 设置提醒:', todo.title, '在', todo.reminderTime);
  },
  ...
  cancelReminder(todoId) {
    if (this._reminderTimers && this._reminderTimers[todoId]) {
      ...
      console.log('[TodoStorePatch] 取消提醒:', todoId);
    }
  },
  ...
  importTodos(store, jsonData) {
    try {
      ...
      console.log('[TodoStorePatch] 导入待办:', newTasks.length);
