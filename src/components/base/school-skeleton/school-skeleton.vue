  ...
  <view class="skeleton-container" :class="{ 'dark-mode': isDark }">
    ...
    <view class="skeleton-step-bar glass-card">
      <view class="skeleton-step">
        ...
        <view class="skeleton-step-text"></view>
      </view>
    ...
    <!-- 表单骨架 (step 1) -->
    <view class="skeleton-form glass-card" v-if="step === 1">
      <view class="skeleton-form-header">
        <view class="skeleton-title"></view>
        <view class="skeleton-subtitle"></view>
      </view>
      <view class="skeleton-input-group" v-for="i in 5" :key="i">
    ...
    <!-- 结果列表骨架 (step 2) -->
    <view class="skeleton-result" v-if="step === 2">
      ...
      <!-- 院校卡片骨架 -->
      <view class="skeleton-school-card glass-card" v-for="i in 3" :key="i">
        <view class="skeleton-card-header">
          <view class="skeleton-school-info">
            <view class="skeleton-school-name"></view>
            <view class="skeleton-school-loc"></view>
            <view class="skeleton-tags">
              <view class="skeleton-tag" v-for="j in 3" :key="j"></view>
            </view>
          </view>
          <view class="skeleton-match-rate"></view>
        </view>

        <view class="skeleton-major">
          <view class="skeleton-major-title"></view>
          <view class="skeleton-scores">
            <view class="skeleton-score-col" v-for="k in 4" :key="k">
              <view class="skeleton-score-year"></view>
              <view class="skeleton-score-num"></view>
            </view>
          </view>
        </view>

        <view class="skeleton-card-footer">
          <view class="skeleton-footer-btn"></view>
          <view class="skeleton-footer-btn primary"></view>
        </view>
      </view>
    </view>
  </view>
