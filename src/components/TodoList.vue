<template>
  <view class="todo-list">
    ...
    <view class="list-header">
      <text class="header-title">To do</text>
      <text class="header-progress">{{ progressValue }}%</text>
    </view>
      ...
      >
        ...
        <view class="item-left">
          <view 
            ...
            :class="{ 'is-completed': item.completed, 'unchecked': !item.completed }"
          >
            <svg v-if="item.completed" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round">
        ...
        <view 
          class="item-priority" 
          :class="'priority-' + getPriorityClass(item, index)"
        >
