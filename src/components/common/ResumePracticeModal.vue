<template>
  <view class="resume-modal-mask" v-if="visible" @tap="handleMaskClick">
    <view class="resume-modal-content" @tap.stop>
      ...
      <!-- 草稿信息 -->
      <view class="draft-info" v-if="draftInfo">
        <view class="info-row">
        ...
        <view class="info-row">
          ...
          <text class="info-value">{{ draftInfo.formattedTime }}</text>
        </view>
        <view class="info-row">
          <text class="info-label">保存时间</text>
          <text class="info-value time-ago">{{ draftInfo.timeAgo }}</text>
        </view>
      </view>
