<template>
    <view class="study-trend-chart">
        ...
        <view class="range-selector">
            <view v-for="range in ranges" :key="range.value" class="range-item"
                :class="{ active: selectedRange === range.value }" @tap="selectRange(range.value)">
        ...
        <view class="summary-row">
            ...
            <view class="summary-item">
                <text class="summary-value">{{ avgMinutes }}</text>
                <text class="summary-label">日均(分钟)</text>
            </view>
            <view class="summary-item">
                <view class="trend-indicator" :class="trendDirection">
                    <text class="trend-arrow">{{ trendDirection === 'up' ? '↑' : trendDirection === 'down' ? '↓' : '→' }}</text>
