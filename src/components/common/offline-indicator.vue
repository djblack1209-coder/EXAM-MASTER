<template>
  ...
  >
    ...
    <view class="offline-indicator__compact">
      ...
      <text class="offline-indicator__text">{{ statusText }}</text>
    ...
    <view v-if="expanded" class="offline-indicator__details">
      ...
      <view v-if="isOffline" class="offline-indicator__detail-item">
        ...
        <text class="detail-value">{{ offlineDurationText }}</text>
      </view>
...
<script>
import { networkMonitor, NETWORK_QUALITY } from '@/utils/network-monitor.js'
