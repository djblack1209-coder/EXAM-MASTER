...
<template>
  <view :class="['empty-state', `empty-state--${theme}`, `empty-state--${size}`]">
    ...
    <view v-if="type === 'guide' && showButton" class="empty-state__action">
      <view
        :class="['action-btn', theme === 'dark' ? 'action-btn--glow' : 'action-btn--primary']"
        @tap="handleAction"
      >
        <text v-if="buttonIcon" class="btn-icon">
          {{ buttonIcon }}
...
export default {
  ...
  methods: {
    ...
    vibrate() {
      ...
      } catch (e) { console.warn('[EmptyState] 震动反馈失败:', e.message || e); }
    },
...
.empty-state {
  ...
  &--small {
    padding: 32rpx 24rpx;
    .empty-state__icon { width: 80rpx; height: 80rpx; }
    .icon-emoji { font-size: 48rpx; }
    .empty-state__title { font-size: 28rpx; }
    .empty-state__desc { font-size: 24rpx; }
  }

  &--medium {
    padding: 48rpx 32rpx;
    .empty-state__icon { width: 120rpx; height: 120rpx; }
    .icon-emoji { font-size: 64rpx; }
    .empty-state__title { font-size: 36rpx; }
    .empty-state__desc { font-size: 28rpx; }
  }

  &--large {
    padding: 64rpx 40rpx;
    .empty-state__icon { width: 160rpx; height: 160rpx; }
    .icon-emoji { font-size: 80rpx; }
    .empty-state__title { font-size: 40rpx; }
    .empty-state__desc { font-size: 30rpx; }
  }
  ...
  &--light {
    ...
    .empty-state__title { color: $color-text-light; }
    .empty-state__desc { color: $color-text-secondary-light; }
    .empty-state__hint { color: #94a3b8; }
  }
  ...
  &--dark {
    ...
    .empty-state__title { color: $color-text-dark; }
    .empty-state__desc { color: $color-text-secondary-dark; }
    .empty-state__hint { color: rgba(255, 255, 255, 0.5); }
  }
}
...
.guide-btn {
  ...
  &--tertiary {
    .empty-state--light & {
      ...
      .guide-btn__title { color: $color-text-light; }
      .guide-btn__desc { color: $color-text-secondary-light; }
      .guide-btn__arrow { color: #94a3b8; }
    }
    ...
    .empty-state--dark & {
      ...
      .guide-btn__title { color: $color-text-dark; }
      .guide-btn__desc { color: $color-text-secondary-dark; }
      .guide-btn__arrow { color: rgba(255, 255, 255, 0.4); }
    }
  }
  ...
  &__icon {
    ...
    &--green { background: rgba(255, 255, 255, 0.2); }
