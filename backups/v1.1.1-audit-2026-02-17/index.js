...
const config = {
  ...
  security: {
    /**
         ...
         */
    obfuscationKey: getEnv('VITE_OBFUSCATION_KEY', 'ExM@st3r_2026'),

    /**
         * 请求签名盐值（FNV-1a 防篡改）
         * 配置方式：VITE_REQUEST_SIGN_SALT=your_salt
         */
    requestSignSalt: getEnv('VITE_REQUEST_SIGN_SALT', 'ExM@st3r')
  },
  ...
  deepLink: {
    ...
    /**
         * 邀请签名密钥
         * 配置方式：VITE_INVITE_SECRET=your_secret
         */
 ...
 */
{
  ...
  const optionalKeys = [
    ...
    { key: 'VITE_OBFUSCATION_KEY', label: '存储混淆密钥', value: null }
  ];
