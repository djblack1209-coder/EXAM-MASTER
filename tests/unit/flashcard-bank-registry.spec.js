...
describe('published flashcard bank registry', () => {
  ...
  it('publishes at least one usable bank for the real practice flow', async () => {
    ...
    const english22012 = await loadBankData('english2-2012');
    expect(english22012.cards).toHaveLength(48);
    expect(english22012.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english22012.cards.find((card) => card.number === 1).answer).toBe('A');
    expect(english22012.cards.find((card) => card.number === 21).answer).toBe('A');
    expect(english22012.cards.find((card) => card.number === 30).answer).toBe('C');
    expect(english22012.cards.find((card) => card.number === 46).targetSegment).toContain('brain drain');
    expect(english22012.cards.find((card) => card.number === 48).question).toContain('某公司员工工作满意度调查');
    expect(english22012.cards.find((card) => card.number === 48).answerEvidence.evidenceRole).toBe(
      'official_writing_prompt'
    );
    const english22013 = await loadBankData('english2-2013');
    expect(english22013.cards).toHaveLength(48);
    expect(english22013.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english22013.cards.find((card) => card.number === 1).answer).toBe('A');
    expect(english22013.cards.find((card) => card.number === 21).answer).toBe('A');
    expect(english22013.cards.find((card) => card.number === 30).answer).toBe('D');
    expect(english22013.cards.find((card) => card.number === 41).answer).toBe('F');
    expect(english22013.cards.find((card) => card.number === 45).answer).toBe('D');
    expect(english22013.cards.find((card) => card.number === 46).targetSegment).toContain(
    ...
    const english22017 = await loadBankData('english2-2017');
    expect(english22017.cards).toHaveLength(48);
    expect(english22017.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english22017.cards.find((card) => card.number === 1).answer).toBe('C');
    expect(english22017.cards.find((card) => card.number === 21).answer).toBe('A');
    expect(english22017.cards.find((card) => card.number === 30).answer).toBe('A');
    expect(english22017.cards.find((card) => card.number === 41).answer).toBe('E');
    expect(english22017.cards.find((card) => card.number === 45).answer).toBe('F');
    expect(english22017.cards.find((card) => card.number === 46).targetSegment).toContain(
      'My dream has always been to work somewhere'
    );
    expect(english22017.cards.find((card) => card.number === 48).question).toContain(
    ...
    const english22019 = await loadBankData('english2-2019');
    expect(english22019.cards).toHaveLength(48);
    expect(english22019.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english22019.cards.find((card) => card.number === 1).answer).toBe('C');
    expect(english22019.cards.find((card) => card.number === 21).answer).toBe('C');
    expect(english22019.cards.find((card) => card.number === 30).answer).toBe('A');
    expect(english22019.cards.find((card) => card.number === 41).answer).toBe('D');
    expect(english22019.cards.find((card) => card.number === 45).answer).toBe('B');
    expect(english22019.cards.find((card) => card.number === 46).targetSegment).toContain(
      'It is easy to underestimate English writer James Herriot'
    );
    expect(english22019.cards.find((card) => card.number === 48).question).toContain(
      '某高校2013年和2018年本科毕业生去向统计'
    );
    expect(english22019.cards.find((card) => card.number === 48).answerEvidence.evidenceRole).toBe(
      'official_writing_prompt'
    );
    const english22020 = await loadBankData('english2-2020');
    expect(english22020.cards).toHaveLength(48);
    expect(english22020.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english22020.cards.find((card) => card.number === 1).answer).toBe('B');
    expect(english22020.cards.find((card) => card.number === 21).answer).toBe('A');
    expect(english22020.cards.find((card) => card.number === 30).answer).toBe('A');
    expect(english22020.cards.find((card) => card.number === 41).answer).toBe('E');
    expect(english22020.cards.find((card) => card.number === 45).answer).toBe('C');
    expect(english22020.cards.find((card) => card.number === 46).targetSegment).toContain(
      "It's almost impossible to go through life without experiencing some kind of failure"
    );
    expect(english22020.cards.find((card) => card.number === 48).question).toContain(
      '某高校学生手机阅读目的调查'
    );
    ...
    const english2019 = await loadBankData('english1-2019');
    expect(english2019.cards).toHaveLength(52);
    expect(english2019.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(english2019.cards.find((card) => card.number === 1).answer).toBe('C');
    expect(english2019.cards.find((card) => card.number === 21).answer).toBe('A');
    expect(english2019.cards.find((card) => card.number === 30).answer).toBe('B');
    expect(english2019.cards.find((card) => card.number === 41).answer).toBe('E');
    expect(english2019.cards.find((card) => card.number === 45).answer).toBe('A');
    expect(english2019.cards.find((card) => card.number === 46).targetSegment).toContain('medical journals');
    expect(english2019.cards.find((card) => card.number === 51).question).toContain(
      'Aiding Rural Primary Schools'
    );
    expect(english2019.cards.find((card) => card.number === 52).answerEvidence.evidenceRole).toBe(
      'official_writing_prompt'
    );
    ...
    expect(english2020.cards.find((card) => card.number === 1).answer).toBe('C');
    expect(english2020.cards.find((card) => card.number === 21).answer).toBe('C');
    expect(english2020.cards.find((card) => card.number === 30).answer).toBe('D');
    expect(english2020.cards.find((card) => card.number === 41).answer).toBe('C');
    expect(english2020.cards.find((card) => card.number === 45).answer).toBe('D');
    expect(english2020.cards.find((card) => card.number === 46).targetSegment).toContain(
      "With the Church's teachings"
    );
    expect(english2020.cards.find((card) => card.number === 51).question).toContain('upcoming singing contest');
    expect(english2020.cards.find((card) => card.number === 52).question).toContain('习惯');
    expect(english2020.cards.find((card) => card.number === 52).answerEvidence.evidenceRole).toBe(
      'official_writing_prompt'
    );
    ...
    const math32016 = await loadBankData('math3-2016');
    expect(math32016.cards).toHaveLength(23);
    expect(math32016.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(math32016.cards.find((card) => card.number === 1).answer).toContain('a=1');
    expect(math32016.cards.find((card) => card.number === 11).answer).toBe('D');
    expect(math32016.cards.find((card) => card.number === 23).answerImages.at(-1).src).toContain(
      'question-bank/math3-2016/answer-page-19.jpg'
    );
    const math32017 = await loadBankData('math3-2017');
    expect(math32017.cards).toHaveLength(23);
    expect(math32017.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(math32017.cards.find((card) => card.number === 1).answer).toBe('A');
    expect(math32017.cards.find((card) => card.number === 14).answer).toBe('9/2');
    ...
    const math32019 = await loadBankData('math3-2019');
    expect(math32019.cards).toHaveLength(23);
    expect(math32019.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(math32019.cards.find((card) => card.number === 1).answer).toBe('C');
    expect(math32019.cards.find((card) => card.number === 14).answer).toBe('2/3');
    expect(math32019.cards.find((card) => card.number === 23).answerImages.at(-1).src).toContain(
      'question-bank/math3-2019/answer-page-12.jpg'
    );
    const math32020 = await loadBankData('math3-2020');
    expect(math32020.cards).toHaveLength(23);
    expect(math32020.cards.every((card) => card.answerEvidenceStatus === 'matched')).toBe(true);
    expect(math32020.cards.find((card) => card.number === 1).answer).toBe('B');
    expect(math32020.cards.find((card) => card.number === 14).answer).toBe('8/7');
    expect(math32020.cards.find((card) => card.number === 23).answerImages.at(-1).src).toContain(
  ...
  it('builds public-course navigation tree without exposing disabled banks', () => {
    ...
    expect(english.tracks[0].yearSlots.find((slot) => slot.year === '2019')).toMatchObject({
      bankId: 'english1-2019',
      status: 'ready',
      statusLabel: '正式',
      clickable: true
    });
    expect(english.tracks[0].yearSlots.find((slot) => slot.year === '2020')).toMatchObject({
      bankId: 'english1-2020',
      status: 'ready',
      statusLabel: '正式',
      clickable: true
    });
