...
def is_missing_answer(card: dict[str, Any]) -> bool:
    return not normalize_text(card.get("answer"))
...
def repair_bank(
    ...
    *,
    ...
    answer_candidates, answer_conflicts = collect_answer_candidates(companion_paths, output_source_map=output_source_map)
