...
- `docs/PROJECT-REPORT.md` — 整合5份历史项目/测试报告
- `docs/AUDIT-REPORT.md` — 整合检测汇总报告 + 模块详细报告 + 审计记录
- `docs/TECH-ANALYSIS.md` — 技术分析与优化方案（从根目录迁移）
- API 速查表合并至 `docs/API_DOCUMENTATION.md` 顶部
