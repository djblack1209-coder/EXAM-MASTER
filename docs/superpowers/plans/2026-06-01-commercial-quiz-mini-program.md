...
### Task 64: Publish English II 2011 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2011_bank.py`
- Add: `src/config/flashcard-banks/english2-2011.json`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a registry/load regression for `english2-2011` expecting 48 cards, matched answer evidence, q01 answer `A`, q21 answer `B`, q30 answer `A`, q46 translation anchor `greenhouse gases`, q48 domestic car market-share chart prompt, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js
```

Failed because `english2-2011` was not registered or compressed yet, and the English II year-map summary was still `正式 2 · 整理中 0 · 待入库 15`.

- [x] **Step 2: Verify source and build text-layer bank**

Downloaded or reused canonical local raw-inbox sources:

```text
data/raw-inbox/src_c9921e1888e48f26536951d8-2011.pdf
data/raw-inbox/src_34920bd67b9ce30f9cbc9b25-2011年考研英语二真题.pdf
data/raw-inbox/src_8bd9ac5ed7ab193f2a431a90-2011年真题及答案速查.pdf
data/raw-inbox/src_3fda0a6cb3395e70fc15ffa1-2011年真题逐题细解.pdf
```

Added `build_english2_2011_bank.py` with 48 cards. The builder uses the answer-speed PDF text layer for question/answer matching, records all four canonical source hashes in `sourceFiles`, cross-checks stable detailed-analysis anchors, and treats writing cards as official-prompt tasks.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2011_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2011.json`, registered `english2-2011`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2011_bank.py
npm test -- tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/question-bank-release-gate.spec.js tests/unit/release-blocker-backlog.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=23`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=25` and `publicCourseBlockedSlots=23`; English II year-map summary is now `正式 3 · 整理中 0 · 待入库 14`; the release-priority dry-run now starts at English II 2012 paired candidates.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js scripts/cleaning/build_english2_2011_bank.py src/config/flashcard-banks/english2-2011.json
...
### Task 66: Publish English II 2013 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2013_bank.py`
- Add: `src/config/flashcard-banks/english2-2013.json`
- Add: `tests/unit/english2-2013-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a focused registry/load regression for `english2-2013` expecting 48 cards, matched answer evidence, q01 answer `A`, q21 answer `A`, q30 answer `D`, Part B answers `FEGCD`, q46 translation anchor `Hair opened on Broadway`, q48 `某高校学生兼职情况` chart prompt, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2013-data.spec.js
```

Failed because `english2-2013` was not registered or compressed yet.

- [x] **Step 2: Verify source and build text-layer bank**

Downloaded canonical local raw-inbox sources:

```text
data/raw-inbox/src_981353ccba33be94890cf3fd-2013.pdf
data/raw-inbox/src_77d3fc4090196fc36c7bf02f-2013年考研英语二真题.pdf
data/raw-inbox/src_c53f74716ec2055f905ab102-2013年真题及答案速查.pdf
data/raw-inbox/src_08c274b630b1a3b559673a70-2013年真题逐题细解.pdf
```

Source audit: page counts `22/15/16/40`, with SHA-256 hashes `777bf0d06a8be66ea050ca7dd179bdb165da7c49cbc6640dba71b8db67cf505e`, `dd9b664c4ae014d95e537b9557e562b094819fdb16c0cdb00d8a65568678e40b`, `d8f155daeb35a6d683eda7bf52cf4af37e5d4528bd83eb1d15a51a95ca63ba04`, and `a775a5aee3c5ecaf67025ee2315768511ff75aa9a268f854673954c672e40d30`. Added `build_english2_2013_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, subtitle-selection Part B, and prompt-only writing evidence.
...
Result: published `src/config/flashcard-banks/english2-2013.json`, registered `english2-2013`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2013_bank.py
npm test -- tests/unit/english2-2013-data.spec.js
npm test -- tests/unit/question-bank-year-map.spec.js
npm test -- tests/unit/flashcard-bank-registry.spec.js
npm test -- tests/unit/english2-2013-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=21`, `publishedSlots=70`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=23` and `publicCourseBlockedSlots=21`; English II year-map summary is now `正式 5 · 整理中 0 · 待入库 12`; the rebuilt release-priority dry-run now starts at English II 2014 paired candidates.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2013-data.spec.js scripts/cleaning/build_english2_2013_bank.py src/config/flashcard-banks/english2-2013.json
git -c core.hooksPath=/dev/null commit -m "chore: publish english2 2013 bank"
```

### Task 67: Publish English II 2014 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2014_bank.py`
- Add: `src/config/flashcard-banks/english2-2014.json`
- Add: `tests/unit/english2-2014-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a focused registry/load regression for `english2-2014` expecting 48 cards, matched answer evidence, q01 answer `B`, q21 answer `B`, q30 answer `D`, Part B answers `DEGCA`, q46 translation anchor `Most people would define optimism`, q48 `20年间中国城镇人口与乡村人口变化图` chart prompt, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2014-data.spec.js
```

Failed because `english2-2014` was not registered or compressed yet.
...
```text
data/raw-inbox/src_9900688bb11e744c7567d491-2014.pdf
data/raw-inbox/src_936d884aa30de09fe48f9eb2-2014年考研英语二真题.pdf
data/raw-inbox/src_32d7ee3bbd74494d32545ef0-2014年真题及答案速查.pdf
data/raw-inbox/src_c0573caed49cb1360668f00c-2014年真题逐题细解.pdf
```

Source audit: page counts `22/15/16/40`, with SHA-256 hashes `1de3730b9a1e89dcc2845d123fdb9caec06e90a7f95a2cb1e4fb63930a5fe355`, `6677d5e01eeecb87e0a3d3312c3f963e04b7e90da42722a0679b7ac99a6e4b68`, `439bfa001be00628953faaa771ade3baabd9f65667c3297bb95866f68a122170`, and `116e35bfdb0e1fd10f7d1a00943e6dde8af91d3df16bf09b44bd9e9a90eb9d4e`. Added `build_english2_2014_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, Land Art Part B information matching, and prompt-only writing evidence.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2014_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2014.json`, registered `english2-2014`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2014_bank.py
npm test -- tests/unit/english2-2014-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=20`, `publishedSlots=71`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=22` and `publicCourseBlockedSlots=20`; English II year-map summary is now `正式 6 · 整理中 0 · 待入库 11`; the rebuilt release-priority dry-run now starts at English II 2015 paired candidates.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2014-data.spec.js scripts/cleaning/build_english2_2014_bank.py src/config/flashcard-banks/english2-2014.json
git -c core.hooksPath=/dev/null commit -m "chore: publish english2 2014 bank"
```

### Task 68: Publish English II 2015 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2015_bank.py`
- Add: `src/config/flashcard-banks/english2-2015.json`
- Add: `tests/unit/english2-2015-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a focused registry/load regression for `english2-2015` expecting 48 cards, matched answer evidence, q01 answer `A`, q21 answer `A`, q30 answer `D`, Part B answers `DEGAC`, q46 translation anchor `Think about driving a route that's very familiar`, q48 `我国某市居民春节假期花销比例` chart prompt, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2015-data.spec.js
```

Failed because `english2-2015` was not registered or compressed yet.
...
```text
data/raw-inbox/src_bc9bdd2b47254ff5fa5bc408-2015.pdf
data/raw-inbox/src_9861ae9bce681b33f3f0495e-2015年考研英语二真题.pdf
data/raw-inbox/src_26e806e10a80d41b9831037e-2015年真题及答案速查.pdf
data/raw-inbox/src_8b13d0b1c2873318eac3e777-2015年真题逐题细解.pdf
```

Source audit: page counts `24/15/16/40`, with SHA-256 hashes `92a45f0d2055e38e633830c7c021ae0576abf7f0ec4dc603a9fbaa958379b49f`, `4a0958a6693404194a3439df52c86acaa64ee1fa9ba03fb57b4402d1b9dc6f54`, `97ef9ecf0641c24934aa6e4ec63b6debbbf453b3c1cd776e0b7a0f63461177ed`, and `acd007957fa5af8fdaa5a9cffc2767c03b5f92c6bca7b24cff848dae0d630feb`. Added `build_english2_2015_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, Old Truths Part B subtitle matching, and prompt-only writing evidence.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2015_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2015.json`, registered `english2-2015`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2015_bank.py
npm test -- tests/unit/english2-2015-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=19`, `publishedSlots=72`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=21` and `publicCourseBlockedSlots=19`; English II year-map summary is now `正式 7 · 整理中 0 · 待入库 10`; the rebuilt release-priority dry-run now starts at English II 2016 paired candidates and Math III 2016.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2015-data.spec.js scripts/cleaning/build_english2_2015_bank.py src/config/flashcard-banks/english2-2015.json
...
### Task 70: Publish English II 2017 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2017_bank.py`
- Add: `src/config/flashcard-banks/english2-2017.json`
- Add: `tests/unit/english2-2017-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a focused registry/load regression for `english2-2017` expecting 48 cards, matched answer evidence, q01 answer `C`, q21 answer `A`, q30 answer `A`, Part B answers `EAGBF`, q46 translation anchor `My dream has always been to work somewhere in an area between fashion and publishing`, q48 museum chart prompt with `4165`, `4692`, `6378`, and `7811`, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2017-data.spec.js
```

Failed because `english2-2017` was not registered or compressed yet.
...
```text
data/raw-inbox/src_d048e4f82dccc6edfd4675a4-2017.pdf
data/raw-inbox/src_f44d6b155a346867e2790bcf-2017年考研英语二真题.pdf
data/raw-inbox/src_79ee7f93299f87bb47e7cab8-2017年真题及答案速查.pdf
data/raw-inbox/src_33b2ddfa8acc83436d3d5b70-2017年真题逐题细解.pdf
```

Source audit: SHA-256 hashes `140fe41b9df2f47a8c254a739b2d90c77a275155b094c4bf7e7aceb694e62906`, `a35ee9cc948b84fea690ba815d1c37af5478df4549f7db596f0bd252a9fe90e7`, `a629f2a9716392f56ffc834dfd098ab0bf42c6d87778225678f1e7026b492517`, and `ba51923c663dcb1d134a946e3d42a02c3d4aa38f863bd5cdbbce37fa8c6d3f2c`. Added `build_english2_2017_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, person-to-information Part B matching, prompt-only writing evidence, and explicit OCR/promo leakage guards for the known 2017 tail page.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2017_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2017.json`, registered `english2-2017`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2017_bank.py
npm test -- tests/unit/english2-2017-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=17`, `publishedSlots=74`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=19` and `publicCourseBlockedSlots=17`; English II year-map summary is now `正式 9 · 整理中 0 · 待入库 8`; the rebuilt release-priority dry-run now starts at English II 2018 paired candidates and Math III 2016.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2017-data.spec.js scripts/cleaning/build_english2_2017_bank.py src/config/flashcard-banks/english2-2017.json
git -c core.hooksPath=/dev/null commit -m "chore: publish english2 2017 bank"
```

### Task 71: Publish English II 2018 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2018_bank.py`
- Add: `src/config/flashcard-banks/english2-2018.json`
- Add: `tests/unit/english2-2018-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Added a focused registry/load regression for `english2-2018` expecting 48 cards, matched answer evidence, q01 answer `D`, q21 answer `B`, q30 answer `C`, Part B answers `AFEBD`, q46 translation anchor `A fifth grader gets a homework assignment to select his future career path`, no q46 `英语（二）试题` page-footer leakage, q48 restaurant-selection chart values `特色36.3%`, `服务26.8%`, `环境23.8%`, `价格8.4%`, and `其他4.7%`, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2018-data.spec.js
```

Failed because `english2-2018` was not registered or compressed yet. A later focused RED check also caught q46 page-footer leakage in the compressed loaded bank before the builder footer filter and compressed table refresh were applied.
...
```text
data/raw-inbox/src_bb76d07247dcb5e9691b37dc-2018.pdf
data/raw-inbox/src_d94f09a02cc4c2e33c83c874-2018年考研英语二真题.pdf
data/raw-inbox/src_304822354811c024c7644fe7-2018年真题及答案速查.pdf
data/raw-inbox/src_8ca8d55ed290ecfc593c4aef-2018年真题逐题细解.pdf
```

Source audit: SHA-256 hashes `97c2978573312f8d90747367df7277d00ac0d608245e8af760f8973a8c0e76ce`, `6bc6010b7b01262859fcb75d1fa641751c2c9cdbfeda49fde17b38401f670e1e`, `f15c6c39d6fa72410ad3be6a6bce4ea24900fd7c4d483ff70918cf0cde1ef3c1`, and `c4218f9f49f3a8fb1d510ab059fe4636f4b099e44ea0a542c527553da5d6a730`. Added `build_english2_2018_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, A-G subtitle Part B matching, prompt-only writing evidence, and explicit footer/OCR leakage guards.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2018_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2018.json`, registered `english2-2018`, regenerated the compressed practice-bank table, and removed q46 page-footer leakage from the loaded bank.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2018_bank.py
npm test -- tests/unit/english2-2018-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=16`, `publishedSlots=75`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=18` and `publicCourseBlockedSlots=16`; English II year-map summary is now `正式 10 · 整理中 0 · 待入库 7`; the rebuilt release-priority dry-run now starts at English II 2019 paired candidates followed by Math III 2016.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2018-data.spec.js scripts/cleaning/build_english2_2018_bank.py src/config/flashcard-banks/english2-2018.json
git -c core.hooksPath=/dev/null commit -m "chore: publish english2 2018 bank"
```

### Task 72: Publish English II 2019 Text-Layer Bank

**Files:**
- Add: `scripts/cleaning/build_english2_2019_bank.py`
- Add: `src/config/flashcard-banks/english2-2019.json`
- Add: `tests/unit/english2-2019-data.spec.js`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Confirmed `codegraph status` and the Codegraph MCP live check both work with an up-to-date index: 611 files, 9,517 nodes, 22,092 edges, 18.75 MB DB. Also checked the plugin cache compatibility symlinks and found no broken links under `openai-curated/*/83d1f0d2 -> 2b564709`.

- [x] **Step 1: Add failing registry coverage**

Added a focused registry/load regression for `english2-2019` expecting 48 cards, matched answer evidence, q01 answer `C`, q21 answer `C`, q30 answer `A`, Part B answers `DGFCB`, q46 translation anchor `It is easy to underestimate English writer James Herriot`, no q46 `英语（二）试题` page-footer leakage, q48 graduate-destination chart values `80.0%`, `2013年`, and `2018年`, and q48 `official_writing_prompt` evidence.

Initial result:
```bash
npm test -- tests/unit/english2-2019-data.spec.js
```

Failed because `english2-2019` was not registered or compressed yet.
...
```text
data/raw-inbox/src_f60e4219c81bc8a4489b9223-2019.pdf
data/raw-inbox/src_e4bdc96c3ef9004d2fe974ac-2019年考研英语二真题.pdf
data/raw-inbox/src_7389cb9947ec7ddd99d292b0-2019年真题及答案速查.pdf
data/raw-inbox/src_cfa93547827765ecc4459d62-2019年真题逐题细解.pdf
```

Source audit: page counts 30, 15, 16, and 40; SHA-256 hashes `f401d6046ed7107f9c6a9cd95c471d8ec4288143d16e6785dea252126f189846`, `cafa49b185d833e5a66eb9a4565a52bea19cf66203ab83e1a2db93491aba8be1`, `f834134df975a390bac8a9c9bac35178a00a855e3cbb8c2bf2a4cb5b4ef796f8`, and `feea3ffaa884f8491a18805cf2edfc3348d8b20238149c9c5badac7d37e4e0b3`. Rendered the writing page to verify chart values because the PDF text layer only exposed axis labels and the chart title.

Added `build_english2_2019_bank.py` with 48 cards, answer-speed text matching, detailed-analysis anchor cross-checks, A-G person-to-information Part B matching, prompt-only writing evidence, and explicit footer/OCR leakage guards.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_english2_2019_bank.py
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/english2-2019.json`, registered `english2-2019`, and regenerated the compressed practice-bank table.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_english2_2019_bank.py
npm test -- tests/unit/english2-2019-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Result: passed on 2026-06-03. The 2005-2020 release gate reports `coverageGaps=15`, `publishedSlots=76`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=17` and `publicCourseBlockedSlots=15`; English II year-map summary is now `正式 11 · 整理中 0 · 待入库 6`; the rebuilt release-priority dry-run now starts at English II 2020 paired candidates followed by Math III 2016/2017.

- [x] **Step 5: Commit**

Run:
```bash
git add data/release-blocker-backlog.json docs/08C-SCRIPTS-REFERENCE.md docs/12-CHANGELOG.md docs/frontend-experience-refactor-diary.md docs/superpowers/plans/2026-06-01-commercial-quiz-mini-program.md src/config/bank-registry.js src/pages/practice-sub/bank-data-table.js tests/unit/flashcard-bank-registry.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/english2-2019-data.spec.js scripts/cleaning/build_english2_2019_bank.py src/config/flashcard-banks/english2-2019.json
...
### Task 75: Publish Math III 2017 Page-Image Bank

**Files:**
- Add: `scripts/cleaning/build_math3_2017_bank.py`
- Add: `src/config/flashcard-banks/math3-2017.json`
- Add: `tests/unit/math3-2017-data.spec.js`
- Add: `cdn-assets/question-bank/math3-2017/*`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Confirmed Codegraph MCP remained healthy with 617 indexed files, 9,681 nodes, and 22,720 edges. Local PDF/tooling support was available: Poppler `pdfinfo`/`pdftotext`/`pdftoppm`, ffmpeg, tesseract, Node, npm, Python, `rg`, and git.

Ran the release-priority queue for the first `math3:2017` task. The Baidu Pan download completed and wrote the ignored source:

```text
data/raw-inbox/src_1903dd7b391b0dc5da099c74-2017年考研数学三真题及解析.pdf
```

The AI cleaning runner then hit the same unsupported iflow model / slow fallback backend pattern, so the release path used deterministic PDF rendering, OCR audit, and visual crop QA.

- [x] **Step 1: Add failing registry coverage**

Added a focused registry/load regression for `math3-2017` expecting registration, 23 cards, matched answer evidence, q01 answer `A`, q04 answer `C`, q08 answer `B`, q09 answer `π^3/2`, q14 answer `9/2`, q15 answer containing `2/3`, q23 answer evidence ending at `question-bank/math3-2017/answer-page-09.jpg`, and q23 split question crops under `question-bank/math3-2017/question-23-a.jpg` and `question-bank/math3-2017/question-23-b.jpg`.

Initial result:
```bash
npm test -- tests/unit/math3-2017-data.spec.js
```

Failed because `math3-2017` was not registered or compressed yet.
...
```bash
pdfinfo data/raw-inbox/src_1903dd7b391b0dc5da099c74-2017年考研数学三真题及解析.pdf
pdftotext data/raw-inbox/src_1903dd7b391b0dc5da099c74-2017年考研数学三真题及解析.pdf -
```

Result: 9-page scanned PDF, no usable text layer, SHA-256 `cbef03ba3e2afb6d8467f0fabb97c2f7fde8f8f298a5c318057b6299dc2d9a56`. Visual/OCR inspection showed the source interleaves question prompts with immediate answer analysis; there are no standalone ad-only pages, but question crops must stop before the following analysis blocks.

Added `build_math3_2017_bank.py` with 23 cards, 9 rendered evidence pages, 24 pre-answer question crop assets, and q23 split across two question crop images.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_math3_2017_bank.py --force-assets
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/math3-2017.json`, generated `cdn-assets/question-bank/math3-2017`, registered `math3-2017`, and regenerated 92 compressed practice-bank entries.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_math3_2017_bank.py
npm test -- tests/unit/math3-2017-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
asset = Path('cdn-assets/question-bank/math3-2017')
out_dir = Path('tmp/pdfs/math3-2017-question-ocr')
out_dir.mkdir(parents=True, exist_ok=True)
for img in sorted(asset.glob('question-*.jpg')):
    out = out_dir / img.stem
    subprocess.run(['tesseract', str(img), str(out), '-l', 'chi_sim+eng', '--psm', '6'], check=False)
bad = []
for txt in sorted(out_dir.glob('question-*.txt')):
    data = txt.read_text(errors='ignore')
    flags = [word for word in ['详解', '应该选', '所以选', '解：', '解】', '故选择'] if word in data]
    if flags:
        bad.append((txt.name, flags))
print({'bad': bad})
raise SystemExit(1 if bad else 0)
PY
```

Result: passed on 2026-06-03. `math3-2017.json` has 23 cards, `{single_choice:8, short_answer:15}`, section counts `{选择题:8, 填空题:6, 解答题:9}`, all cards carry `answerEvidenceStatus=matched`, and the final OCR leakage scan over 24 question crop images found no answer/analysis markers. The 2005-2020 release gate reports `coverageGaps=12`, `publishedSlots=79`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=14` and `publicCourseBlockedSlots=12`; the rebuilt release-priority dry-run now starts at `2018年考研数学三真题及解析.pdf`, then `2019年考研数学三真题及解析.pdf`, then `2020年考研英语一真题.pdf`.

### Task 76: Publish Math III 2018 Page-Image Bank

**Files:**
- Add: `scripts/cleaning/build_math3_2018_bank.py`
- Add: `src/config/flashcard-banks/math3-2018.json`
- Add: `tests/unit/math3-2018-data.spec.js`
- Add: `cdn-assets/question-bank/math3-2018/*`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Confirmed Codegraph MCP remained healthy with 620 indexed files, 9,732 nodes, and 22,817 edges. Local PDF/tooling support was available: Poppler `pdfinfo`/`pdftotext`/`pdftoppm`, ffmpeg, tesseract, Node, npm, Python, `rg`, and git.

The release-priority queue had advanced to the `math3:2018` source. The ignored local PDF was present after the cleaning runner download:

```text
data/raw-inbox/src_96a8e7cbc8f19d8e26451784-2018年考研数学三真题及解析.pdf
```

The AI cleaning runner again hit unsupported/slow backend behavior, so the release path used deterministic PDF rendering, OCR audit, and visual crop QA.

- [x] **Step 1: Add failing registry coverage**

Added a focused registry/load regression for `math3-2018` expecting registration, 23 cards, matched answer evidence, q01 answer `D`, q02 answer `D`, q08 answer `B`, q09 answer `y=4x-3`, q14 answer `1/3`, q15 containing `a=1`, q16 containing `sqrt(3)π/32`, q23 answer evidence ending at `question-bank/math3-2018/answer-page-14.jpg`, and q08 split question crops under `question-bank/math3-2018/question-08-a.jpg` and `question-bank/math3-2018/question-08-b.jpg`.

Initial result:
```bash
npm test -- tests/unit/math3-2018-data.spec.js
```

Failed because `math3-2018` was not registered or compressed yet.
...
```bash
pdfinfo data/raw-inbox/src_96a8e7cbc8f19d8e26451784-2018年考研数学三真题及解析.pdf
pdftotext data/raw-inbox/src_96a8e7cbc8f19d8e26451784-2018年考研数学三真题及解析.pdf -
pdftoppm -r 130 -jpeg -jpegopt quality=70 data/raw-inbox/src_96a8e7cbc8f19d8e26451784-2018年考研数学三真题及解析.pdf tmp/pdfs/math3-2018-jpeg-preview/answer-page
```

Result: 14-page scanned PDF, no usable text layer, 1,594,638 bytes. Visual/OCR inspection showed the source interleaves question prompts with immediate answer analysis; page 14 is the continuation of q23 answer evidence, not an ad-only page.

Added `build_math3_2018_bank.py` with 23 cards, 14 rendered evidence pages, 24 pre-answer question crop assets, and q08 split across two question crop images.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_math3_2018_bank.py --force-assets
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/math3-2018.json`, generated `cdn-assets/question-bank/math3-2018`, registered `math3-2018`, and regenerated 93 compressed practice-bank entries.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_math3_2018_bank.py
npm test -- tests/unit/math3-2018-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Question-image leakage scan:
```bash
rm -rf tmp/pdfs/math3-2018-question-ocr
mkdir -p tmp/pdfs/math3-2018-question-ocr
for p in cdn-assets/question-bank/math3-2018/question-*.jpg; do
  base=$(basename "$p" .jpg)
  tesseract "$p" "tmp/pdfs/math3-2018-question-ocr/$base" -l chi_sim+eng --psm 6
done
rg -n "答案|解析|详解|故选|所以选|应该选|故选择" tmp/pdfs/math3-2018-question-ocr
```

Result: passed on 2026-06-03. `math3-2018.json` has 23 cards, `{single_choice:8, short_answer:15}`, section counts `{选择题:8, 填空题:6, 解答题:9}`, all cards carry `answerEvidenceStatus=matched`, and the final OCR leakage scan over 24 question crop images found no answer/analysis markers. The source PDF's q01 prompt contains the original `错误!未找到引用源` text, which is preserved as source text rather than treated as leakage. The 2005-2020 release gate reports `coverageGaps=11`, `publishedSlots=80`, `sourceEvidenceGaps=1`, and `pendingCoverageBlockers=0`; release backlog reports `blockers=13` and `publicCourseBlockedSlots=11`; the rebuilt release-priority dry-run now starts at `2019年考研数学三真题及解析.pdf`, then `2020年考研数学三真题及解析.pdf`, then `2020年考研英语一真题.pdf`.

### Task 77: Publish Math III 2019 Page-Image Bank

**Files:**
- Add: `scripts/cleaning/build_math3_2019_bank.py`
- Add: `src/config/flashcard-banks/math3-2019.json`
- Add: `tests/unit/math3-2019-data.spec.js`
- Add: `cdn-assets/question-bank/math3-2019/*`
- Modify: `src/config/bank-registry.js`
- Modify: `src/pages/practice-sub/bank-data-table.js`
- Modify: `tests/unit/flashcard-bank-registry.spec.js`
- Modify: `tests/unit/question-bank-year-map.spec.js`
...
Confirmed Codegraph MCP was healthy with 623 indexed files, 9,822 nodes, and 22,990 edges. Duplicate MCP server processes were reduced back to one active codegraph/context7/xcodebuild/playwright set, and no cleaning runner, pdf2flashcard, or tesseract process was left running.

The release-priority queue had advanced to the `math3:2019` source. The ignored local PDF was downloaded into:

```text
data/raw-inbox/src_72f4c3221cc958781119c8d1-2019年考研数学三真题及解析.pdf
```
...
Added a focused registry/load regression for `math3-2019` expecting registration, 23 cards, matched answer evidence, q01 answer `C`, q04 answer `B`, q08 answer `A`, q09 answer `e^(-1)`, q14 answer `2/3`, q21 containing `x=3`, q23 answer evidence ending at `question-bank/math3-2019/answer-page-12.jpg`, plus split q04/q22 question crops.

Initial result:
```bash
npm test -- tests/unit/math3-2019-data.spec.js
```

Failed because `math3-2019` was not registered or compressed yet.
...
```bash
pdfinfo data/raw-inbox/src_72f4c3221cc958781119c8d1-2019年考研数学三真题及解析.pdf
pdftotext data/raw-inbox/src_72f4c3221cc958781119c8d1-2019年考研数学三真题及解析.pdf -
pdftoppm -r 130 -jpeg -jpegopt quality=70 data/raw-inbox/src_72f4c3221cc958781119c8d1-2019年考研数学三真题及解析.pdf tmp/pdfs/math3-2019-jpeg-preview/answer-page
```

Result: 12-page scanned PDF, no usable text layer, 1,522,505 bytes. Visual/OCR inspection showed the source interleaves question prompts with immediate answer analysis; q04 crosses pages 1-2, q22 spans page 10 plus page 11 top, and page 12 is q23 answer continuation.

Added `build_math3_2019_bank.py` with 23 cards, 12 rendered evidence pages, 25 pre-answer question crop assets, q04 split across two question images, and q22 split across two question images.

- [x] **Step 3: Register and refresh practice data**

Run:
```bash
python3 scripts/cleaning/build_math3_2019_bank.py --force-assets
node scripts/build/generate-compressed-bank-modules.mjs
```

Result: published `src/config/flashcard-banks/math3-2019.json`, generated `cdn-assets/question-bank/math3-2019`, registered `math3-2019`, and regenerated 94 compressed practice-bank entries.

- [x] **Step 4: Run validation**

Run:
```bash
python3 -m py_compile scripts/cleaning/build_math3_2019_bank.py
npm test -- tests/unit/math3-2019-data.spec.js tests/unit/question-bank-year-map.spec.js tests/unit/flashcard-bank-registry.spec.js
node scripts/build/question-bank-release-gate.mjs --min-year=2005 --max-year=2020
node scripts/build/release-blocker-backlog.mjs
python3 scripts/baidu/cleaning_queue.py
python3 scripts/baidu/run_cleaning_queue.py --dry-run --limit 12 --source-type official_paper --paper-role main --max-year 2020
...
Question-image leakage scan:
```bash
rm -rf tmp/pdfs/math3-2019-question-ocr
mkdir -p tmp/pdfs/math3-2019-question-ocr
for p in cdn-assets/question-bank/math3-2019/question-*.jpg; do
  base=$(basename "$p" .jpg)
  tesseract "$p" "tmp/pdfs/math3-2019-question-ocr/$base" -l chi_sim+eng --psm 6
done
rg -n "答案|解析|详解|故选|所以选|应该选|故选择" tmp/pdfs/math3-2019-question-ocr
```
